...
namespace EzySlice {
    ...
    public sealed class Slicer {
        ...
        public static SlicedHull Slice(GameObject obj, Plane pl, TextureRegion crossRegion, Material crossMaterial) {
            ...
            //SkinnedMeshRenderer renderer = FindObjectOfType<SkinnedMeshRenderer>();

            //CONNOR
            /*
            if (!renderer)
            {
                SkinnedMeshRenderer rendererS = obj.GetComponent<SkinnedMeshRenderer>();
            }
            */
            //
            ...
            //CONNOR
            //COmmented out, moved to function above
